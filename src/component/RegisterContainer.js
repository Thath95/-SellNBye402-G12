...
export default class RegisterContainer extends Component {
    ...
    onSubmit(e) {
        ...
        axios.post('http://localhost:4000/trainReservations/users/register', userDetails).then(res => {
            let data = res.data;
    ...
    render() {
        return <div>
            <Card border="success" style={{width: '40%', marginTop: "20px", marginLeft: "auto", marginRight: "auto"}}>
