...
export default class LoginContainer extends Component {
    ...
    onLoginClicked(e) {
        ...
        //
        axios.post('http://localhost:4000/trainReservations/users/login', userCredentials).then(res => {
            let data = res.data;
    ...
    render() {
        return <div>
            <Card style={{width: "30%", marginTop: "60px", marginLeft: "auto", marginRight: "auto"}}>
                <Card.Header as="h3">
